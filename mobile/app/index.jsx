...
const styles = StyleSheet.create({
  ...
  logoVersao: { fontSize: 14, color: COLORS.textDim, marginTop: 8, letterSpacing: 1, fontFamily: FONTS.regular },
  ...
  cardTitle: { fontFamily: FONTS.semibold, fontSize: 13, letterSpacing: 2, color: COLORS.textDim },
  label: { fontSize: 13, letterSpacing: 1, color: COLORS.textDim, fontFamily: FONTS.semibold, marginBottom: 6 },
  input: { backgroundColor: COLORS.surface2, borderWidth: 1, borderColor: COLORS.border, borderRadius: 8, color: COLORS.text, padding: 12, fontSize: 18, fontFamily: 'monospace', marginBottom: 10 },
  hint: { fontSize: 15, color: COLORS.textDim, marginBottom: 14, lineHeight: 18, fontFamily: FONTS.regular },
  erroTxt: { color: COLORS.red, fontSize: 15, marginBottom: 12, lineHeight: 18, fontFamily: FONTS.regular },

  // --- Botões ---
  btn: { borderRadius: 8, padding: 14, alignItems: 'center', justifyContent: 'center', marginBottom: 14, minHeight: 48 },
  btnPrimary: { backgroundColor: COLORS.accent },
  btnPrimaryTxt: { color: COLORS.onAccent, fontFamily: FONTS.bold, fontSize: 15, letterSpacing: 2 },
  ...
  btnConectarTxt: { color: COLORS.green, fontFamily: FONTS.bold, fontSize: 14, letterSpacing: 2 },
  btnDisabled: { opacity: 0.6 },
  btnDanger: { borderWidth: 1, borderColor: COLORS.red },
  btnDangerTxt: { color: COLORS.red, fontFamily: FONTS.semibold, fontSize: 14, letterSpacing: 2 },
  ...
  statusTxt: { fontSize: 13, letterSpacing: 0.3, fontFamily: FONTS.semibold },
  ...
  avancadasTxt: { fontSize: 14, color: COLORS.textDim, fontFamily: FONTS.regular, opacity: 0.8 },
  ...
  previewBlackoutMsg: { fontSize: 15, color: 'rgba(255,255,255,0.45)', letterSpacing: 3, fontFamily: FONTS.semibold },
  previewLabel: { fontSize: 12, color: COLORS.accent, letterSpacing: 2, fontFamily: FONTS.semibold, marginBottom: 10 },
  previewTitulo: { fontSize: 13, color: COLORS.accent2, letterSpacing: 2, fontFamily: FONTS.semibold, marginBottom: 8 },
  previewDualRow: {
    flexDirection: 'row',
    gap: 12,
    marginTop: 6,
  ...
  previewLetras: { fontSize: 18, color: COLORS.text, textAlign: 'center', lineHeight: 26, fontFamily: FONTS.regular },
