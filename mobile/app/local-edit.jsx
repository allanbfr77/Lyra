...
const styles = StyleSheet.create({
  ...
  cultoAtualTxt: { flex: 1, fontSize: 12, color: COLORS.textDim, fontFamily: FONTS.regular },
  cultoAtualStrong: { color: COLORS.accent, fontFamily: FONTS.semibold },
  cultoTrocar: { fontSize: 12, color: COLORS.accent2, fontFamily: FONTS.semibold },
  cultoAviso: { fontSize: 11, color: COLORS.accent2, marginBottom: 12, fontFamily: FONTS.regular },
