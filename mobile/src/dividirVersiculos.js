 ...
 *
 * Cópia do módulo puro do Controlador (`controller/public/js/modules/dividirVersiculos.js`)
 * para o app mobile poder aplicar a mesma opção «Leitura» ao projetar.
 *
 * Com a opção desligada, `dividirVersiculos` é a função identidade — uma parte por
 * versículo, texto intacto.
 */
